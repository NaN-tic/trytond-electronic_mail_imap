...
class TestCase(ModuleTestCase):
    ...
    def test_get_mails(self):
        ...
        for mail in received_mails:
            self.assertEqual(mail.subject, u'My test Email')
        self.assertNotEqual(received_mails[0].message_id,
            received_mails[1].message_id)
        self.assertEqual(received_mails[0].rec_name, u'My test Email (ID: 1)')
        self.assertEqual(received_mails[1].rec_name, u'My test Email (ID: 2)')
